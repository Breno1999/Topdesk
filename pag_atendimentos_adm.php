...
<?php
    ...
    include_once('session_protect_adm.php');
?>
        ...
        <?php
            ...
            $cmd = $conn->query("SELECT *, date_format(data_solicitacao, '%d/%m/%Y %H:%i:%s') as dt_solicitacao_form, date_format(data_conclusao, '%d/%m/%Y %H:%i:%s') as dt_conclusao_form FROM atendimentos WHERE status_atendimento = 'Em atendimento' or status_atendimento = 'Não iniciado' or status_atendimento = 'Concluído' and date(data_solicitacao) = '$data'");
